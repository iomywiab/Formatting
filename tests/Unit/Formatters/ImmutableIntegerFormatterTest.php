...
#[CoversClass(ImmutableIntegerFormatter::class)]
...
class ImmutableIntegerFormatterTest extends TestCase
{
     ...
     */
    public function testToString(int $input, string $expectedString): void
    {
        $part = new ImmutableIntegerFormatter();
        self::assertSame($expectedString, $part->toString($input));

        $part = new ImmutableIntegerFormatter(new ImmutableTemplateReplacer('{value}'));
        self::assertSame($expectedString, $part->toString($input));
    }
}
